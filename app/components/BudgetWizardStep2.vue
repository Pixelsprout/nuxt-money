...
<template>
  <div class="space-y-6">
    ...
    <UModal
      v-if="isDesktop"
      v-model:open="showTransactionSelector"
    ...
    <!-- Transaction Selector Drawer (Mobile) -->
    <UDrawer v-else v-model:open="showTransactionSelector">
      <template #header>
        <h3 class="text-lg font-semibold">Select a Transaction</h3>
      </template>
